...
CREATE TABLE `cars` (
  ...
  `location` varchar(100) DEFAULT 'Davao'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cars` (`id`, `model`, `make`, `year`, `type`, `price_per_day`, `availability`, `location`) VALUES
(1, 'Toyota Vios', 'Toyota', 2020, 'Sedan', 1500.00, 1, 'Davao'),
(2, 'Honda CR-V', 'Honda', 2019, 'SUV', 2500.00, 0, 'Davao'),
(3, 'Nissan Almera', 'Nissan', 2018, 'Sedan', 1400.00, 1, 'Davao'),
(4, 'Mitsubishi Xpander', 'Mitsubishi', 2020, 'MPV', 2200.00, 1, 'Davao'),
(5, 'Ford Ranger', 'Ford', 2018, 'Pickup', 2700.00, 1, 'Davao'),
(6, 'Hyundai Accent', 'Hyundai', 2017, 'Sedan', 1600.00, 1, 'Davao'),
(35, 'Hyundai Grand Starex', 'Hyundai', 2016, 'Van', 2800.00, 1, 'Davao'),
(36, 'Tonery Tiggo 2', 'Tiggo', 2024, 'SUV', 2200.00, 1, 'Davao'),
(37, 'Toyota Fortuner', 'Toyota', 2016, 'SUV', 3200.00, 1, 'Davao'),
(38, 'Toyota HiAce', 'Toyota', 2016, 'Van', 2900.00, 1, 'Davao'),
(39, 'Toyota Hilux', 'Toyota', 2017, 'Pickup', 2800.00, 1, 'Davao'),
(40, 'Toyota Scion xB', 'Toyota', 2004, 'Compact', 1800.00, 1, 'Davao'),
(41, 'Kia Picanto', 'Kia', 2003, 'Compact', 1200.00, 1, 'Davao');
